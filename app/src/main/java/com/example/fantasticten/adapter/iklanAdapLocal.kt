...
class iklanAdapLocal (private val newsList: ArrayList<iklan_item>): RecyclerView.Adapter<iklanAdapLocal.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): iklanAdapLocal.MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.iklan_item,parent,false)
        return MyViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: iklanAdapLocal.MyViewHolder, position: Int) {
